...
// Lives beside the gateway it names jobs for. The photo-job worker needs the same rule and
// has no request to reach a controller from, so the function moved to where both can see it.
